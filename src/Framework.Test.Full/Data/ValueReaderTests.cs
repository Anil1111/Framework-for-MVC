//-----------------------------------------------------------------------
// <copyright file="ValueReaderTests.cs" company="Genesys Source">
...
namespace Framework.Test
{
    ...
    public class ValueReaderTests
    {
        ...
        /// </summary>
        [TestMethod()]
        public void Data_ValueReader_CountAny()
        {
        ...
        /// </summary>
        [TestMethod()]
        public void Data_ValueReader_GetAll()
        {
            var reader = new ValueReader<CustomerType>();
        ...
        /// <summary>
        /// Data_ValueReader_GetById
        /// </summary>
        [TestMethod()]
        public void Data_ValueReader_GetById()
        {
            var reader = new ValueReader<CustomerType>();
        ...
        /// </summary>
        [TestMethod()]
        public void Data_ValueReader_GetByKey()
        {
            var reader = new ValueReader<CustomerType>();
        ...
        /// <remarks></remarks>
        [TestMethod()]
        public void Data_ValueReader_GetWhere()
        {
        ...
        /// </summary>
        [TestMethod()]
        public void Data_ValueReader_Lists()
        {
        ...
        /// </summary>
        [TestMethod()]
        public void Data_ValueReader_Singles()
        {
            var reader = new ValueReader<CustomerType>();
